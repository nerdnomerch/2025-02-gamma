...
contract WithdrawalExecuteAtomicCoverage is BeforeAfter {
    //       /\_/\           ___
    //    = o_o =_______    \ \  EXECUTE ATOMIC WITHDRAWAL COVERAGE
    //     __^      __(  \.__) )
    // (@)<_____>__(_____)____/
    function _checkExecuteAtomicWithdrawalCoverage(
        ...
        _logWithdrawalReceiverCoverage_executeAtomicWithdrawal(
        ...
        _logWithdrawalMarketCoverage_executeAtomicWithdrawal(
            withdrawalProps.addresses.market
        );
        _logWithdrawalLongTokenSwapPathCoverage_executeAtomicWithdrawal(
            withdrawalProps.addresses.longTokenSwapPath
        );
        _logWithdrawalShortTokenSwapPathCoverage_executeAtomicWithdrawal(
            withdrawalProps.addresses.shortTokenSwapPath
        );
        _logWithdrawalMarketTokenAmountCoverage_executeAtomicWithdrawal(
            withdrawalProps.numbers.marketTokenAmount
        );
        _logWithdrawalMinLongTokenAmountCoverage_executeAtomicWithdrawal(
            withdrawalProps.numbers.minLongTokenAmount
        );
        _logWithdrawalMinShortTokenAmountCoverage_executeAtomicWithdrawal(
            withdrawalProps.numbers.minShortTokenAmount
        );
        // _logWithdrawalUpdatedAtBlockCoverage_executeAtomicWithdrawal(
        //     withdrawalProps.numbers.updatedAtBlock
        // );
        _logWithdrawalUpdatedAtTimeCoverage_executeAtomicWithdrawal(
            withdrawalProps.numbers.updatedAtTime
        );
        _logWithdrawalExecutionFeeCoverage_executeAtomicWithdrawal(
            withdrawalProps.numbers.executionFee
        );
        _logWithdrawalCallbackGasLimitCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalAccountCoverage_executeAtomicWithdrawal(
        address account
    ) internal {
        if (account == USER0) {
    ...
    function _logWithdrawalReceiverCoverage_executeAtomicWithdrawal(
        address receiver
    ) internal {
        if (receiver == USER0) {
    ...
    function _logWithdrawalCallbackContractCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalUiFeeReceiverCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalMarketCoverage_executeAtomicWithdrawal(
        address market
    ) internal {
    ...
    function _logWithdrawalLongTokenSwapPathCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalShortTokenSwapPathCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalMarketTokenAmountCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalMinLongTokenAmountCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalMinShortTokenAmountCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalUpdatedAtBlockCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalUpdatedAtTimeCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalExecutionFeeCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalCallbackGasLimitCoverage_executeAtomicWithdrawal(
    ...
    function _logWithdrawalShouldUnwrapNativeTokenCoverage_executeAtomicWithdrawal(
