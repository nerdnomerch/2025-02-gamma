...
contract WithdrawalCancelCoverage is BeforeAfter {
    //       /\_/\           ___
    //    = o_o =_______    \ \  CANCEL WITHDRAWAL COVERAGE
    //     __^      __(  \.__) )
    // (@)<_____>__(_____)____/

    function _checkCancelWithdrawalCoverage(
        Withdrawal.Props memory withdrawalProps
    ) internal {
        _logWithdrawalAccountCoverage_cancelWithdrawal(
            withdrawalProps.addresses.account
        );
        _logWithdrawalReceiverCoverage_cancelWithdrawal(
            withdrawalProps.addresses.receiver
        );
        _logWithdrawalCallbackContractCoverage_cancelWithdrawal(
            withdrawalProps.addresses.callbackContract
        );
        _logWithdrawalUiFeeReceiverCoverage_cancelWithdrawal(
            withdrawalProps.addresses.uiFeeReceiver
        );
        _logWithdrawalMarketCoverage_cancelWithdrawal(
            withdrawalProps.addresses.market
        );
        _logWithdrawalLongTokenSwapPathCoverage_cancelWithdrawal(
            withdrawalProps.addresses.longTokenSwapPath
        );
        _logWithdrawalShortTokenSwapPathCoverage_cancelWithdrawal(
            withdrawalProps.addresses.shortTokenSwapPath
        );
        _logWithdrawalMarketTokenAmountCoverage_cancelWithdrawal(
        ...
        _logWithdrawalMinShortTokenAmountCoverage_cancelWithdrawal(
            withdrawalProps.numbers.minShortTokenAmount
        );
        // _logWithdrawalUpdatedAtBlockCoverage_cancelWithdrawal(
        //     withdrawalProps.numbers.updatedAtBlock
        // );
        _logWithdrawalUpdatedAtTimeCoverage_cancelWithdrawal(
            withdrawalProps.numbers.updatedAtTime
        );
        _logWithdrawalExecutionFeeCoverage_cancelWithdrawal(
            withdrawalProps.numbers.executionFee
        );
        _logWithdrawalCallbackGasLimitCoverage_cancelWithdrawal(
            withdrawalProps.numbers.callbackGasLimit
        );
        _logWithdrawalShouldUnwrapNativeTokenCoverage_cancelWithdrawal(
            withdrawalProps.flags.shouldUnwrapNativeToken
        );
    }

    function _logWithdrawalAccountCoverage_cancelWithdrawal(
        address account
    ) internal {
        if (account == USER0) {
    ...
    function _logWithdrawalReceiverCoverage_cancelWithdrawal(
        address receiver
    ) internal {
        if (receiver == USER0) {
    ...
    function _logWithdrawalCallbackContractCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalUiFeeReceiverCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalMarketCoverage_cancelWithdrawal(
        address market
    ) internal {
    ...
    function _logWithdrawalLongTokenSwapPathCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalShortTokenSwapPathCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalMarketTokenAmountCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalMinLongTokenAmountCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalMinShortTokenAmountCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalUpdatedAtBlockCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalUpdatedAtTimeCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalExecutionFeeCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalCallbackGasLimitCoverage_cancelWithdrawal(
    ...
    function _logWithdrawalShouldUnwrapNativeTokenCoverage_cancelWithdrawal(
