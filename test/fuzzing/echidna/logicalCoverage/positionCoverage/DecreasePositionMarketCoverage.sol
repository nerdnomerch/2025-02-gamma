...
contract DecreasePositionMarketCoverage is BeforeAfter {
    //       /\_/\           ___
    //    = o_o =_______    \ \  DECREASE POSITION
    //     __^      __(  \.__) )  GET MARKET INFO
    // (@)<_____>__(_____)____/    COVERAGE

    function _checkDecreaseOrderAndGetMarketInfoCoverage(
        ReaderUtils.MarketInfo memory marketInfo
    ) internal {
        _logMarketInfoMarketTokenCoverage_decreasePosition(
            marketInfo.market.marketToken
        );
        _logMarketInfoIndexTokenCoverage_decreasePosition(
            marketInfo.market.indexToken
        );
        _logMarketInfoLongTokenCoverage_decreasePosition(
            marketInfo.market.longToken
        );
        _logMarketInfoShortTokenCoverage_decreasePosition(
            marketInfo.market.shortToken
        );
        _logMarketInfoBorrowingFactorPerSecondForLongsCoverage_decreasePosition(
            marketInfo.borrowingFactorPerSecondForLongs
        );
        _logMarketInfoBorrowingFactorPerSecondForShortsCoverage_decreasePosition(
            marketInfo.borrowingFactorPerSecondForShorts
        );
        _logMarketInfoBaseFundingLongFundingFeeAmountPerSizeCoverage_decreasePosition(
            marketInfo.baseFunding.fundingFeeAmountPerSize.long
        );
        _logMarketInfoBaseFundingShortFundingFeeAmountPerSizeCoverage_decreasePosition(
            marketInfo.baseFunding.fundingFeeAmountPerSize.short
        );
        _logMarketInfoBaseFundingLongClaimableFundingAmountPerSizeCoverage_decreasePosition(
            marketInfo.baseFunding.claimableFundingAmountPerSize.long
        );
        _logMarketInfoBaseFundingShortClaimableFundingAmountPerSizeCoverage_decreasePosition(
            marketInfo.baseFunding.claimableFundingAmountPerSize.short
        );
        _logMarketInfoNextFundingLongsPayShortsCoverage_decreasePosition(
            marketInfo.nextFunding.longsPayShorts
        );
        _logMarketInfoNextFundingFundingFactorPerSecondCoverage_decreasePosition(
            marketInfo.nextFunding.fundingFactorPerSecond
        );
        _logMarketInfoNextFundingNextSavedFundingFactorPerSecondCoverage_decreasePosition(
            marketInfo.nextFunding.nextSavedFundingFactorPerSecond
        );
        _logMarketInfoNextFundingLongFundingFeeAmountPerSizeDeltaCoverage_decreasePosition(
            marketInfo.nextFunding.fundingFeeAmountPerSizeDelta.long
        );
        _logMarketInfoNextFundingShortFundingFeeAmountPerSizeDeltaCoverage_decreasePosition(
            marketInfo.nextFunding.fundingFeeAmountPerSizeDelta.short
        );
        _logMarketInfoNextFundingLongClaimableFundingAmountPerSizeDeltaCoverage_decreasePosition(
            marketInfo.nextFunding.claimableFundingAmountPerSizeDelta.long
        );
        _logMarketInfoNextFundingShortClaimableFundingAmountPerSizeDeltaCoverage_decreasePosition(
        ...
        _logMarketInfoVirtualInventoryVirtualPoolAmountForShortTokenCoverage_decreasePosition(
            marketInfo.virtualInventory.virtualPoolAmountForShortToken
        );
        _logMarketInfoVirtualInventoryVirtualInventoryForPositionsCoverage_decreasePosition(
            marketInfo.virtualInventory.virtualInventoryForPositions
        );
        _logMarketInfoIsDisabledCoverage_decreasePosition(
            marketInfo.isDisabled
        );
    }

    function _logMarketInfoMarketTokenCoverage_decreasePosition(
        address marketToken
    ) internal {
    ...
    function _logMarketInfoIndexTokenCoverage_decreasePosition(
        address indexToken
    ) internal {
    ...
    function _logMarketInfoLongTokenCoverage_decreasePosition(
        address longToken
    ) internal {
    ...
    function _logMarketInfoShortTokenCoverage_decreasePosition(
        address shortToken
    ) internal {
    ...
    function _logMarketInfoBorrowingFactorPerSecondForLongsCoverage_decreasePosition(
    ...
    function _logMarketInfoBorrowingFactorPerSecondForShortsCoverage_decreasePosition(
    ...
    function _logMarketInfoBaseFundingLongFundingFeeAmountPerSizeCoverage_decreasePosition(
    ...
    function _logMarketInfoBaseFundingShortFundingFeeAmountPerSizeCoverage_decreasePosition(
    ...
    function _logMarketInfoBaseFundingLongClaimableFundingAmountPerSizeCoverage_decreasePosition(
    ...
    function _logMarketInfoBaseFundingShortClaimableFundingAmountPerSizeCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingLongsPayShortsCoverage_decreasePosition(
        bool longsPayShorts
    ) internal {
        if (longsPayShorts) {
    ...
    function _logMarketInfoNextFundingFundingFactorPerSecondCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingNextSavedFundingFactorPerSecondCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingLongFundingFeeAmountPerSizeDeltaCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingShortFundingFeeAmountPerSizeDeltaCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingLongClaimableFundingAmountPerSizeDeltaCoverage_decreasePosition(
    ...
    function _logMarketInfoNextFundingShortClaimableFundingAmountPerSizeDeltaCoverage_decreasePosition(
    ...
    function _logMarketInfoVirtualInventoryVirtualPoolAmountForLongTokenCoverage_decreasePosition(
    ...
    function _logMarketInfoVirtualInventoryVirtualPoolAmountForShortTokenCoverage_decreasePosition(
    ...
    function _logMarketInfoVirtualInventoryVirtualInventoryForPositionsCoverage_decreasePosition(
    ...
    function _logMarketInfoIsDisabledCoverage_decreasePosition(
        bool isDisabled
    ) internal {
        if (isDisabled) {
