...
contract CreateOrderCoverage is BeforeAfter {
    //       /\_/\           ___
    //    = o_o =_______    \ \  CREATE ORDER COVERAGE
    //     __^      __(  \.__) )
    // (@)<_____>__(_____)____/

    function _checkOrderCreatedCoverage(
        OrderCreated memory orderCreated
    ) internal {
        _logReceiverCoverage(orderCreated.createOrderParams.addresses.receiver);
        _logCancellationReceiverCoverage(
            orderCreated.createOrderParams.addresses.cancellationReceiver
        );
        _logCallbackContractCoverage(
            orderCreated.createOrderParams.addresses.callbackContract
        );
        _logUiFeeReceiverCoverage(
            orderCreated.createOrderParams.addresses.uiFeeReceiver
        );
        _logInitialCollateralTokenCoverage(
            orderCreated.createOrderParams.addresses.initialCollateralToken
        );
        _logMarketCoverage(orderCreated.createOrderParams.addresses.market);
        _logSwapPathCoverage(orderCreated.createOrderParams.addresses.swapPath);
        _logOrderTypeCoverage(orderCreated.createOrderParams.orderType);
        _logDecreasePositionSwapTypeCoverage(
            orderCreated.createOrderParams.decreasePositionSwapType
        );
        _logIsLongCoverage(orderCreated.createOrderParams.isLong);
        _logShouldUnwrapNativeTokenCoverage(
            orderCreated.createOrderParams.shouldUnwrapNativeToken
        );
        _logAutoCancelCoverage(orderCreated.createOrderParams.autoCancel);
        _logReferralCodeCoverage(orderCreated.createOrderParams.referralCode);
        _logSizeDeltaUsdCoverage(
            orderCreated.createOrderParams.numbers.sizeDeltaUsd
        );
        _logInitialCollateralDeltaAmountCoverage(
            orderCreated.createOrderParams.numbers.initialCollateralDeltaAmount
        );
        _logTriggerPriceCoverage(
            orderCreated.createOrderParams.numbers.triggerPrice
        );
        _logAcceptablePriceCoverage(
            orderCreated.createOrderParams.numbers.acceptablePrice
        );
        _logExecutionFeeCoverage(
            orderCreated.createOrderParams.numbers.executionFee
        );
        _logCallbackGasLimitCoverage(
            orderCreated.createOrderParams.numbers.callbackGasLimit
        );
        _logMinOutputAmountCoverage(
            orderCreated.createOrderParams.numbers.minOutputAmount
        );
        _logKeyCoverage(orderCreated.key);
        _logUpdatedAtCoverage(orderCreated.updatedAt);
        _logUserCoverage(orderCreated.user);
        _logHandlerTypeCoverage(orderCreated.handlerType);
        _logAmountSentCoverage(orderCreated.amountSent);
        _logIsCloseCoverage(orderCreated.isClose);
    }

    function _logReceiverCoverage(address receiver) internal {
        if (receiver == USER0) {
    ...
    function _logCancellationReceiverCoverage(
    ...
    function _logCallbackContractCoverage(address callbackContract) internal {
    ...
    function _logUiFeeReceiverCoverage(address uiFeeReceiver) internal {
    ...
    function _logInitialCollateralTokenCoverage(
    ...
    function _logMarketCoverage(address market) internal {
    ...
    function _logSwapPathCoverage(address[] memory swapPath) internal {
    ...
    function _logOrderTypeCoverage(Order.OrderType orderType) internal {
    ...
    function _logDecreasePositionSwapTypeCoverage(
    ...
    function _logIsLongCoverage(bool isLong) internal {
        if (isLong) {
    ...
    function _logShouldUnwrapNativeTokenCoverage(
    ...
    function _logAutoCancelCoverage(bool autoCancel) internal {
        if (autoCancel) {
    ...
    function _logReferralCodeCoverage(bytes32 referralCode) internal {
    ...
    function _logSizeDeltaUsdCoverage(uint256 sizeDeltaUsd) internal {
        if (sizeDeltaUsd == 0) {
    ...
    function _logInitialCollateralDeltaAmountCoverage(
    ...
    function _logTriggerPriceCoverage(uint256 triggerPrice) internal {
        if (triggerPrice == 0) {
    ...
    function _logAcceptablePriceCoverage(uint256 acceptablePrice) internal {
    ...
    function _logExecutionFeeCoverage(uint256 executionFee) internal {
        if (executionFee == 0) {
    ...
    function _logCallbackGasLimitCoverage(uint256 callbackGasLimit) internal {
    ...
    function _logMinOutputAmountCoverage(uint256 minOutputAmount) internal {
    ...
    function _logKeyCoverage(bytes32 key) internal {
        if (key == bytes32(0)) {
            fl.log("Key is empty");
        } else {
    ...
    function _logUpdatedAtCoverage(uint256 updatedAt) internal {
        if (updatedAt == 0) {
    ...
    function _logUserCoverage(address user) internal {
        if (user == USER0) {
    ...
    function _logHandlerTypeCoverage(bytes32 handlerType) internal {
    ...
    function _logAmountSentCoverage(uint256 amountSent) internal {
        if (amountSent == 0) {
    ...
    function _logIsCloseCoverage(bool isClose) internal {
        if (isClose) {
